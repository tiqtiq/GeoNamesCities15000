...
PACKAGE="GeoNamesCities${COUNT}"

FILE="geonames${EXPORT}"

# always delete, since modifying w/ drop & re-all will change file checksum
touch "Sources/${PACKAGE}/Resources/${FILE}.db"
rmbk "Sources/${PACKAGE}/Resources/${FILE}.db"

# see: http://download.geonames.org/export/dump/readme.txt
curl -fL "https://download.geonames.org/export/dump/${EXPORT}.zip" | bsdtar -xOf - > /tmp/${FILE}.tsv
